...
export default function GeminiChat() {
  ...
  useEffect(() => {
    setMessages([{ role: 'ai' as const, content: 'Hey there! I’m Gemini, ready to chat.' }]);
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Placeholder: Replace with Gemini API
      setTimeout(() => {
        setMessages((prev) => [
          ...prev,
          { role: 'ai' as const, content: `Gemini response: ${inputCode} (stub)` },
